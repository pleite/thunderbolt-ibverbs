...
counter_keys=${TBV_COUNTER_KEYS:-"dv_poll_wqes dv_admission_attempts dv_backpressure_retry dv_fence_retry dv_hard_error data_wr_copy_error data_wr_retransmit data_wr_timeout data_wr_retry_exhausted data_wr_retransmit_closing_qp data_wr_retransmit_no_live_path data_wr_retransmit_teardown_path data_tx_errors data_rx_canceled data_rx_no_qp data_rx_no_qp_apple data_rx_no_qp_mad data_rx_no_qp_native_ackable data_rx_no_qp_native_non_ack data_rx_no_qp_opcode_1 data_rx_no_qp_opcode_2 data_rx_no_qp_opcode_3 data_rx_no_qp_opcode_4 data_rx_no_qp_opcode_5 data_rx_no_qp_opcode_6 data_rx_no_qp_opcode_7 data_rx_no_qp_opcode_8 data_rx_no_qp_opcode_9 data_rx_no_qp_opcode_10 data_rx_no_qp_opcode_11 data_rx_no_qp_opcode_12 data_rx_no_qp_opcode_13 data_rx_no_qp_reack data_rx_no_qp_error_ack data_rx_duplicate_ack data_qp_tombstone_evicted data_tx_posted data_tx_completed"}
