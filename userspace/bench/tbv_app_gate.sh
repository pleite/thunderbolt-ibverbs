...
if [[ -z "${TBV_COUNTER_KEYS+x}" ]]; then
  counter_keys+=" data_wr_post_reject_status data_wr_post_reject_no_dest data_wr_post_reject_dead_qp data_wr_post_reject_bad_range data_wr_post_reject_sendq data_wr_post_reject_initial_post data_rx_active_duplicate_refresh data_rx_active_write_flush data_rx_active_write_imm_flush data_rx_reorder_duplicate_refresh data_rx_write_imm_future_psn data_rx_write_imm_gap data_rx_write_imm_nonzero_first data_rx_write_imm_reorder_buffered data_rx_write_imm_reorder_delivered"
fi
